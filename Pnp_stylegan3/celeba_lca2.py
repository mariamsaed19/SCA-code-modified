...
df2 =pd.DataFrame(list_of_tuples,
                  columns=['Img', 'Pro'])
df2.to_csv('/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/stylegan3/file/r1/.1lca2.csv', index=False)
def seed2vec(G, seed):
...
csv_file='/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/stylegan3/file/r1/.1lca2.csv'
...
for i in tqdm(range(df.shape[0])):
  ...
  if (psnr_val1>psnr_val2):
    #recon_img1.save (f'//dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/stylegan3/file/r1/plot/.1lca2/recon_img'+str(new_seed)+'.jpg')
    psnr_val=psnr_val1
    ssim_val=ssim_val1
    fid_val=fid_val1
  else:
    #recon_img2.save (f'/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/stylegan3/file/r1/plot/.1lca2/recon_img'+str(new_seed)+'.jpg')
    psnr_val=psnr_val2
    ssim_val=ssim_val2
    fid_val=fid_val2
  #im1.save("geeks.jpg")
...
df_result.to_csv('/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/stylegan3/file/r1/.1lca2.csv', index=False) 
