...
save_dir = "./result/cifar-resnet18-transfer/lca2/"
save_dir_imgs = "./result/cifar-resnet18-transfer/lca2/images"
exp_name = "cifar-resnet18-transfer_lca2_linear"
...
class ResNet18(nn.Module):
    def __init__(
        ...
        super().__init__()
        model = resnet.customized_resnet18(pretrained=True,skip=[1, 1, 1, 1])
...
target_model = ResNet18().to(device=device, dtype=torch.float16)
print(target_model)
# Check what’s frozen
print("ResNet18 frozen layers:")
...
optimiser_target = torch.optim.SGD(filter(lambda p: p.requires_grad, target_model.parameters()),lr=0.001,momentum=0.9)
