...
def attack_test(train_loader, target_model, attack_model):
    ...
    for batch, (data, targets) in enumerate(tqdm(train_loader)):
        ...
        target_outputs=torch.nan_to_num(target_outputs, nan=random.uniform(0.0, 1.0))
        recreated_data = attack_model(target_outputs)
        ...
        if (psnr_val>10.00):
            ...
            plt.draw()
            plt.savefig(f'/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/MedMNIST/plot/spg1/org_img{batch}.jpg', dpi=100, bbox_inches='tight')
            ...
            #plt.imshow(mfcc_spectrogram[0][0,:,:].numpy(), cmap='viridis')
            plt.draw()
            plt.savefig(f'/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/MedMNIST/plot/spg1/recon_img{batch}.jpg', dpi=100, bbox_inches='tight')
...
#torch.save(attack_model, '/vast/home/sdibbo/def_ddlc/model_attack/etn/MNIST_20_epoch_CNN_lca_attack.pt')
#torch.save(target_model, '/vast/home/sdibbo/def_ddlc/model_target/etn/MNIST_20_epoch_CNN_lca_target.pt')

df = pd.DataFrame(list(zip(*[psnr_lst,  ssim_lst, fid_lst]))).add_prefix('Col')

#df.to_csv('/vast/home/sdibbo/def_ddlc/result/etn/MNIST_20_epoch_CNN_attack_lca.csv', index=False)