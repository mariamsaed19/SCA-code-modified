...
torch.save(attack_model, '/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/model/FMNIST_20_epoch_CNN_1l_lca_attack_0.25.pt')
torch.save(target_model, '/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/model/FMNIST_20_epoch_CNN_lca_target_0.25.pt')

df = pd.DataFrame(list(zip(*[psnr_lst,  ssim_lst, fid_lst]))).add_prefix('Col')

df.to_csv('/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/result/FMNIST_20_epoch_CNN_attack_1l_lca_0.25.csv', index=False)