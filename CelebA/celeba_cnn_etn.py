...
train_loader = torch.utils.data.DataLoader(
  torchvision.datasets.CelebA('/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/celeba/data',  split = 'train', target_type = 'identity', download=False,
...
test_loader = torch.utils.data.DataLoader(
  torchvision.datasets.CelebA('/dartfs-hpc/rc/home/h/f0048vh/Sparse_guard/celeba/data', target_type = 'identity', split = 'test', download=False,
                             transform=torchvision.transforms.Compose([
                               torchvision.transforms.ToTensor(),
                               torchvision.transforms.Normalize(
                                 (0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
